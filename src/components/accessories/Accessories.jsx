...
import { HeaderAccessories } from "./HeaderAccessories"
    ...
    return(
        ...
        <div id="main" className="flex flex-row">
            ...
            <div id="body" className="flex flex-col ml-26 mr-1">
                <div id="header" className="mt-1"><HeaderAccessories /></div>
          <div id="filter" className="mt-20 sticky top-0 z-[50] bg-white">
            ...
            />
                ...
                <div id="contents" className="mt-20">
                    <Contents filterCategory="accessories" sortOrder={sortOrder} filters={filters}/>
                </div>
